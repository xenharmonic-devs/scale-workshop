...
class ImageLineExporter extends BaseExporter {
  ...
  static headerBytes = Uint8Array.from([3, 0, 0, 0, 3, 0, 0, 0, this.numberOfNotes, 0, 0, 0])
  ...
  saveHarmorPitchMap() {
    super.saveFile(this.params.filename + '.fnv', this.getFileContents(5), true)
  }

  saveSytrusPitchMap() {
    super.saveFile(this.params.filename + '.fnv', this.getFileContents(4), true)
  }
}
