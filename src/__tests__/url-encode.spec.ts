...
const COMMUNITY_SCALES = [
  [
    "",
    7690.06044720528,
    "?l=dFc_9F8_7F6_5F4_4F3_bF8_3F2_dF8_5F3_7F4_bF6_2F1&version=2.1.0",
  ],
  [
    "12_duodene_marvel",
    7803.732,
  ...
  [
    "",
    4926.272689614714,
    "?l=8F7_6F5_1bFz_1hFz_cF7_9F5_2F1&f=64&version=2.1.0",
  ],
  [
    "",
    7769.54408208727,
...
describe("Decoding of scales found in the wild", () => {
  it.each(COMMUNITY_SCALES)("Decodes %s", (name, checksum, encoded) => {
    ...
    const centsSum = intervals.reduce(
      (total, interval) => total + interval.totalCents(),
      0
    );
