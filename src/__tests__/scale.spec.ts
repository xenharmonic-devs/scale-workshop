...
describe("Scale", () => {
  it("supports just intonation", () => {
    const intervals = [
      new ScaleLine(ExtendedMonzo.fromFraction(new Fraction(5, 4), 3), "ratio"),
      new ScaleLine(ExtendedMonzo.fromFraction(new Fraction(3, 2), 3), "ratio"),
      new ScaleLine(
        ExtendedMonzo.fromFraction(new Fraction(15, 8), 3),
        "ratio"
      ),
      new ScaleLine(ExtendedMonzo.fromFraction(new Fraction(2), 3), "ratio"),
    ];
  ...
  it("supports raw cents", () => {
    const scale = Scale.fromIntervalArray(
      [new ScaleLine(ExtendedMonzo.fromCents(123, 0), "cents")],
      440
    );
  ...
  it("can be octave reduced", () => {
    const intervals = [
      new ScaleLine(ExtendedMonzo.fromFraction(new Fraction(3, 5), 3), "ratio"),
      new ScaleLine(ExtendedMonzo.fromFraction(new Fraction(3), 3), "ratio"),
      new ScaleLine(ExtendedMonzo.fromFraction(new Fraction(2), 3), "ratio"),
    ];
    const baseFrequency = 1000;
  ...
  */
  ...
  it("can generate rank 2", () => {
    const meantoneFifth = new ScaleLine(
      ExtendedMonzo.fromEqualTemperament(
        new Fraction(1, 4),
        new Fraction(5),
        3
  ...
  it("can enumerate a chord", () => {
    const scale = Scale.fromChord(
      [10, 13, 15, 16, 20].map(
        (harmonic) =>
          new ScaleLine(ExtendedMonzo.fromNumber(harmonic, 5), "ratio")
      )
    );
    expect(
  ...
  it("can generate a combination product set", () => {
    const one = new ScaleLine(ExtendedMonzo.fromNumber(1, 4), "ratio");
    const two = new ScaleLine(ExtendedMonzo.fromNumber(2, 4), "ratio");
    const three = new ScaleLine(ExtendedMonzo.fromNumber(3, 4), "ratio");
    const five = new ScaleLine(ExtendedMonzo.fromNumber(5, 4), "ratio");
    const seven = new ScaleLine(ExtendedMonzo.fromNumber(7, 4), "ratio");
  ...
  it("can generate a lattice", () => {
    const two = new ScaleLine(ExtendedMonzo.fromNumber(2, 3), "ratio");
    const three = new ScaleLine(ExtendedMonzo.fromNumber(3, 3), "ratio");
    const five = new ScaleLine(ExtendedMonzo.fromNumber(5, 3), "ratio");
  ...
  it("can generate a scale with a 24-cell symmetry", () => {
    const two = new ScaleLine(ExtendedMonzo.fromNumber(2, 5), "ratio");
    const three = new ScaleLine(ExtendedMonzo.fromNumber(3, 5), "ratio");
    const five = new ScaleLine(ExtendedMonzo.fromNumber(5, 5), "ratio");
    const seven = new ScaleLine(ExtendedMonzo.fromNumber(7, 5), "ratio");
    const eleven = new ScaleLine(ExtendedMonzo.fromNumber(11, 5), "ratio");
  ...
  it("can generate a MOS scale", () => {
    const octave = new ScaleLine(ExtendedMonzo.fromNumber(2, 1), "ratio");
  ...
  */
  ...
  it("can be reverse parsed", () => {
    const scale = Scale.fromIntervalArray([
      ...
      new ScaleLine(ExtendedMonzo.fromCents(1234, 3), "cents"),
      new ScaleLine(ExtendedMonzo.fromCents(1234.5671, 3), "cents", undefined, {
      ...
      new ScaleLine(ExtendedMonzo.fromValue(2, 3), "decimal"),
    ]);
  ...
  it("supports random variance while preserving names", () => {
    const scale = Scale.fromIntervalArray([
      ...
      new ScaleLine(ExtendedMonzo.fromNumber(9, 2), "ratio"),
    ]).vary(10, true);
