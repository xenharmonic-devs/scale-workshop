<template>
  <main id="privacy-policy">
    ...
    <p>
      The Xenharmonic Developers ("us", "we", or "our") operates Scale Workshop (the "Service").
    </p>
    <p>
    ...
    <h4>Tracking</h4>
    <p>
      We use the browser local storage to track the activity on our Service and hold certain
      information.
    </p>
    <p>
      Local storage holds an anonymous unique identifier. This identifier is randomly computed by
      your browser and stored on your device. Tracking technologies also used are beacons, tags, and
      scripts to collect and track information and to improve and analyze our Service.
    </p>
    <p>
      Local storage is specific to this website. You can instruct your browser to refuse the use of
      local storage or to indicate when local storage is being used. However, if you do not accept
      manipulation of the local storage, you may not be able to use some portions of our Service.
    </p>
    <p>Examples of data we store</p>
    <ul>
      <li><strong>Session data.</strong> We store session data to operate our Service.</li>
      <li>
        <strong>Preferences.</strong> We store preferences to remember your preferences and various
        settings.
      </li>
    </ul>
    <h2>Use of Data</h2>
    <p>The Xenharmonic Developers use the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      If you are located outside of the European Union and choose to provide information to us,
      please note that we transfer the data, including Personal Data, to the EU and process it
      there.
    </p>
    <p>
    ...
    <p>
      The Xenharmonic Developers will take all steps reasonably necessary to ensure that your data
    ...
    <p>
      The Xenharmonic Developers may disclose your Personal Data in the good faith belief that such
      action is necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of The Xenharmonic Developers</li>
    ...
    <ul>
      <li>
        ...
        <p>
          ...
          &amp; Terms web page:
          <a rel="nofollow" class="external free" href="https://policies.google.com/privacy?hl=en"
    ...
    <p>
      ...
      13. If you are a parent or guardian and you are aware that your Children has provided us with
    ...
    <p>
      ...
      lumi.pakkanen<img
        alt="@"
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/At_sign.svg/17px-At_sign.svg.png"
        decoding="async"
        title="@"
        width="17"
        height="17"
        srcset="
          https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/At_sign.svg/26px-At_sign.svg.png 1.5x,
          https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/At_sign.svg/34px-At_sign.svg.png 2x
        "
      />gmail.com.
    </p>
  </main>
